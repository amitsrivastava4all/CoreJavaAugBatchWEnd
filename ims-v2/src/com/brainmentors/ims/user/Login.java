...
public class Login extends JFrame {
	...
	private void register() {
		...
		userDTO.setPassword(Encrypt.generatePassword(password));
		
		System.out.println("Userid "+userid +" Password "+password);
		UserDAO userDAO = new UserDAO();
		
			String msg = userDAO.register(userDTO)?"Register SuccessFully":"Error During Register";
	...
	private void doLogin() {
		...
		try {
			...
			if(userDTO.isLoginSuccess() ) {
				...
				this.dispose();
				if(userDTO.getStatus().equalsIgnoreCase("F")) {
